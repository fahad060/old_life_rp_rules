    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="border-b border-border bg-card">
        <div className="container">
          <div className="flex gap-6 py-4 flex-wrap">
            ...
            <Link href="/safe-zones" className="text-primary font-semibold hover:text-accent transition-colors">
              المناطق الآمنة
            </Link>
          </div>
        </div>
      ...
      <main className="container py-12">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold mb-8 text-primary">المناطق الآمنة وغير الآمنة</h2>
          ...
          {/* Additional Rules */}
          <div className="mb-12">
            <h3 className="text-3xl font-bold mb-6 text-primary">القوانين الإضافية</h3>
            <div className="space-y-4">
              <Card className="bg-card border-border p-6">
